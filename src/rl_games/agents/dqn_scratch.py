"""
From-scratch Deep Q-Network (DQN) implementation in PyTorch.
...
Key components:
  ...
  - DQNScratchAgent : the training loop, ε-greedy policy, and target-network sync
"""
...
class DQNScratchAgent:
    ...
    def save(self, path: Path) -> None:
        ...
        print(f"Saved DQN-scratch agent to {path}")
    ...
    def info(self) -> str:
        ...
        return (
            f"DQN-scratch agent for {self.env_id}\n"
